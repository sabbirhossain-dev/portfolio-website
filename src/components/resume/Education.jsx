    ...
    <>
      ...
      animate={{opacity: 1, transition:{duration:.5}}}
       className='flex justify-between flex-col gap-10 lg:flex-row lg:gap-20'>
            ...
            <h3 className="text-sm uppercase font-light text-designColor tracking-wide">1998 - 2010</h3>
            <h1 className="text-4xl md:text-4xl text-gray-300 font-bold capitalize">Education Quality</h1>
            </div>
            <div>
            ...
            <div className='flex flex-col gap-4 font-titleFont mb-14'>
            <h3 className="text-sm uppercase font-light text-designColor tracking-wide">2010 - 2012</h3>
